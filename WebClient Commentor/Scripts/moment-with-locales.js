...
(function (factory) {
    ...
    function processHourStampFunction(str) {
        return function () {
    ...
    return moment.defineLocale('uk', {
        ...
        calendar : {
            sameDay: processHourStampFunction('[Сьогодні '),
            nextDay: processHourStampFunction('[Завтра '),
            lastDay: processHourStampFunction('[Вчора '),
            nextWeek: processHourStampFunction('[У] dddd ['),
            lastWeek: function () {
                switch (this.day()) {
                case 0:
                case 3:
                case 5:
                case 6:
                    return processHourStampFunction('[Минулої] dddd [').call(this);
                case 1:
                case 2:
                case 4:
                    return processHourStampFunction('[Минулого] dddd [').call(this);
                }
            },
            sameElse: 'L'
        },
