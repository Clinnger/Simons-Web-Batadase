...
$.extend($.validator, {
	...
	messages: {
		...
		creditvehicled: "Please enter a valid credit vehicled number.",
	...
	classRuleSettings: {
		...
		digits: {digits: true},
		creditvehicled: {creditvehicled: true}
	},
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/creditvehicled
		// based on http://en.wikipedia.org/wiki/Luhn
		creditvehicled: function(value, element) {
			if ( this.optional(element) )
				return "dependency-mismatch";
